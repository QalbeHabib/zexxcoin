...
const PHASE_5 = new BN(50_000).mul(DECIMALS_MULTIPLIER);
const PHASE_6 = new BN(50_000).mul(DECIMALS_MULTIPLIER);

export const TOKEN_AMOUNTS = {
  // Total supply is sum of all phase allocations
  TOTAL_SUPPLY: PHASE_1.add(PHASE_2)
    .add(PHASE_3)
    .add(PHASE_4)
    .add(PHASE_5)
    .add(PHASE_6), // 1,000,000 tokens
  ...
  PHASE_5_ALLOCATION: PHASE_5, // 50,000 tokens (5%)
  PHASE_6_ALLOCATION: PHASE_6, // 50,000 tokens (5%)
};
...
export const PHASE_PRICES = {
  ...
  PHASE_5: new BN(15_000), // 0.000015 SOL (0.75 SOL total)
  PHASE_6: new BN(20_000), // 0.00002 SOL (1 SOL total)
};
